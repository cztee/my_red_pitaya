...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_register_slice_0_M_AXI [get_bd_intf_pins axi_protocol_converter_0/S_AXI] [get_bd_intf_pins axi_register_slice_0/M_AXI]
  ...
  connect_bd_intf_net -intf_net processing_system7_CAN_0 [get_bd_intf_ports CAN0] [get_bd_intf_pins processing_system7/CAN_0]
  connect_bd_intf_net -intf_net processing_system7_CAN_1 [get_bd_intf_ports CAN1] [get_bd_intf_pins processing_system7/CAN_1]
  ...
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins proc_sys_reset/interconnect_aresetn]
  ...
  connect_bd_net -net processing_system7_0_fclk_clk3 [get_bd_ports FCLK_CLK3] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7/FCLK_CLK3] [get_bd_pins processing_system7/M_AXI_GP1_ACLK] [get_bd_pins xadc/s_axi_aclk]
